...
const WhatWeDo = () => {
  return (
    <>
    <div className="relative flex flex-col lg:flex-row items-center justify-center rounded-lg overflow-hidden mt-5">
      {/* Left Side - Image */}
      <div className="w-full lg:w-1/2 relative">
        <img
          src="../../../src/assests/Section (1).png"
          alt="Farmer in field"
          ...
          <div className="flex justify-around mt-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative w-16 h-16">
                ...
                <img
                  src="../../../src/assests/image (1).png"
                  alt="Circle line"
                  className="w-full h-full"
                />
                {/* Inner Percentage Image */}
                <img
                  src="../../../src/assests/Paragraph+Background (1).png" 
                  alt="90% icon"
            ...
            <div className="flex items-center space-x-4">
              <div className="relative w-16 h-16">
                ...
                {/* Inner Percentage Image */}
                <img
                  src="../../../src/assests/Paragraph+Background.png"
                  alt="78% icon"
                  className="absolute inset-0 w-8 h-8 m-auto" 
                />
              </div>
